...
$config['csrf_token_name'] = 'csrf_test_new_codeigniter';
$config['csrf_cookie_name'] = 'csrf_cookie_new_codeigniter';
$config['csrf_expire'] = 7200;
$config['csrf_regenerate'] = false;
$config['csrf_exclude_uris'] = array("user/ajax_country", "user/fetch_state", "user/fetch_city", 'user/datatable', 'user/data_show');
