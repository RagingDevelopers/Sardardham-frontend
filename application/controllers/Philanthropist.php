...
class Philanthropist extends MY_Controller
{
                ...
                <?php foreach ( $philanthropists as $philanthropist ): ?>
                    <div class="col-lg-6 col-md-6 col-sm-12 p-2">
                        <div class="philanthropist-item">
                            <a href="<?= base_url() ?>upload/<?= $philanthropist['photo']; ?>" target="_blank"
    ...
    {
        $csvFile       = FCPATH . "assets/data.csv";
        $imgSourcePath = FCPATH . "assets/img/";
        $imgUploadPath = FCPATH . "upload/";
            ...
            while ( ($data = fgetcsv($handle, 1000, ",")) !== FALSE ) {
                ...
                if ($record) {
                    ...
                    if (file_exists($from)) {
                        ...
                        $newName = "philanthropist-respected-donors-{$slug}.png";
