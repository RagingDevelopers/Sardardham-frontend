...
class Thought extends CI_Controller {
	...
	public function index() {
	    ...
	    $page_data['page_name'] = "thought";
        $page_data['page_title'] = "Thought";
	...
	public function create(){
	   ...
	   // $this->form_validation->set_rules('photo', 'Photo', 'required');
        ...
        if($this->form_validation->run() == false){
            ...
            redirect(site_url('admin/thought'),'refresh');
        }else{
            ...
            $insert = $this->db->insert('thought',$data);          
            if(isset($insert)){
                $message = array('message'=>"Thought Created Successfully", 'class'=>'success');
            }else{
                $message = array('message'=>"Failed to Create Thought", 'class'=>'danger');
            }
        }
        $this->session->set_flashdata('flash_message',$message);
        redirect(site_url('admin/thought'),'refresh');
	...
	public function edit($param=''){
        ...
        $page_data['page_name'] = 'thought';
        $page_data['languages'] = $languages;
        $page_data['row_data']  =   $this->db->get_where('thought',array('id'=>$param))->row_array();
        $this->load->view('admin/common', $page_data);
	}
	public function update($param=''){
        ...
        if($this->form_validation->run() == false){
            ...
            if(!empty($_FILES['photo']['name'])) {
                $row_data  =  $this->db->get_where('thought',array('id'=>$param))->row('photo');
        	    if(!empty($row_data)) {
	        ...
	        $update = $this->db->update('thought',$data);
	        if(isset($update)){
                $message = array('message'=>"Thought Updated Successfully", 'class'=>'success');
            }else{
                $message = array('message'=>"Failed to Update Thought", 'class'=>'danger');
            }
        }
        $this->session->set_flashdata('flash_message',$message);
        redirect(site_url('admin/thought'),'refresh');
    ...
    public function delete($param='')
	{
        ...
        $delete = $this->db->where('id', $param)->delete('thought');
        
        if(isset($delete)){
            $message = array('message'=>"Thought Delete Successfully", 'class'=>'success');
        }else{
            $message = array('message'=>"Failed to Delete Thought", 'class'=>'danger');
        }
        $this->session->set_flashdata('flash_message',$message);
        redirect(site_url('admin/thought'),'refresh');
	}
	...
	public function fetch_data() {
        ...
        $main_table = 'thought'; // Main table
        $controller_name = "admin/Thought"; // Controller name
        ...
        $orderable_columns = ["$main_table.id", null, "language.name","$main_table.description",null];
