...
class Donation_description extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $page_data['page_name'] = "donation_description";
        $page_data['page_title'] = "Donation Description";
    ...
    public function create()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            redirect(site_url('admin/donation_description'), 'refresh');
        } else {
            ...
            $insert = $this->db->insert('donation_description', $data);
            if (isset($insert)) {
                $message = array('message' => "Description Created Successfully", 'class' => 'success');
            } else {
                $message = array('message' => "Failed to Create Description", 'class' => 'danger');
            }
        }
        $this->session->set_flashdata('flash_message', $message);
        redirect(site_url('admin/donation_description'), 'refresh');
    ...
    public function edit($param = '')
    {
        ...
        $page_data['page_name'] = 'donation_description';
        $page_data['languages'] = $languages;
        $page_data['row_data'] = $this->db->get_where('donation_description', array('id' => $param))->row_array();
        $this->load->view('admin/common', $page_data);
    }
    ...
    public function update($param = '')
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $update = $this->db->update('donation_description', $data);
            if (isset($update)) {
                $message = array('message' => "Description Updated Successfully", 'class' => 'success');
            } else {
                $message = array('message' => "Failed to Update Description", 'class' => 'danger');
            }
        }
        $this->session->set_flashdata('flash_message', $message);
        redirect(site_url('admin/donation_description'), 'refresh');
    ...
    public function fetch_data()
    {
        ...
        $main_table = 'donation_description'; // Main table
        $controller_name = "admin/Donation_description"; // Controller name
