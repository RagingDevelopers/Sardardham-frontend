...
class Skill_development extends CI_Controller {
	...
	public function index() {
        ...
        $page_data['page_title'] = "Skill Development";
	...
	public function create(){
	   ...
	   // $this->form_validation->set_rules('photo', 'Photo', 'required');
        ...
        if($this->form_validation->run() == false){
            ...
            redirect(site_url('admin/skill_development'),'refresh');
        }else{
            ...
            $insert = $this->db->insert('skill_development',$data);          
            if(isset($insert)){
                $message = array('message'=>"Skill Development Created Successfully", 'class'=>'success');
            }else{
                $message = array('message'=>"Failed to Create Skill Development", 'class'=>'danger');
            }
        }
        $this->session->set_flashdata('flash_message',$message);
        redirect(site_url('admin/skill_development'),'refresh');
	...
	public function edit($param=''){
        ...
        $page_data['page_name'] = 'skill_development';
        $page_data['languages'] = $languages;
        $page_data['row_data']  =   $this->db->get_where('skill_development',array('id'=>$param))->row_array();
        $this->load->view('admin/common', $page_data);
	}
	public function update($param=''){
        ...
        if($this->form_validation->run() == false){
	        ...
	        $update = $this->db->update('skill_development',$data);
	        if(isset($update)){
                $message = array('message'=>"Skill Development Updated Successfully", 'class'=>'success');
            }else{
                $message = array('message'=>"Failed to Update Skill Development", 'class'=>'danger');
            }
        }
        $this->session->set_flashdata('flash_message',$message);
        redirect(site_url('admin/skill_development'),'refresh');
    ...
    public function delete($param='')
	{
        ...
        $delete = $this->db->where('id', $param)->delete('skill_development');
        
        if(isset($delete)){
            $message = array('message'=>"Skill Development Delete Successfully", 'class'=>'success');
        }else{
            $message = array('message'=>"Failed to Delete Skill Development", 'class'=>'danger');
        }
        $this->session->set_flashdata('flash_message',$message);
        redirect(site_url('admin/skill_development'),'refresh');
	}
	...
	public function fetch_data() {
        ...
        $main_table = 'skill_development'; // Main table
        $controller_name = "admin/Skill_development"; // Controller name
