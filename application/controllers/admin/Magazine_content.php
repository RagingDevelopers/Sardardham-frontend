...
class Magazine_content extends CI_Controller {
	...
	public function index() {
	    ...
	    $page_data['page_name'] = "magazine_content";
        $page_data['page_title'] = "Magazine Content";
	...
	public function create(){
	   ...
	   // $this->form_validation->set_rules('photo', 'Photo', 'required');
        ...
        if($this->form_validation->run() == false){
            ...
            redirect(site_url('admin/magazine_content'),'refresh');
        }else{
            ...
            $insert = $this->db->insert('magazine_content',$data);          
            if(isset($insert)){
                $message = array('message'=>"Magazine Content Created Successfully", 'class'=>'success');
            }else{
                $message = array('message'=>"Failed to Create Magazine Content", 'class'=>'danger');
            }
        }
        $this->session->set_flashdata('flash_message',$message);
        redirect(site_url('admin/magazine_content'),'refresh');
	...
	public function edit($param=''){
        ...
        $page_data['page_name'] = 'magazine_content';
        $page_data['languages'] = $languages;
        $page_data['row_data']  =   $this->db->get_where('magazine_content',array('id'=>$param))->row_array();
        $this->load->view('admin/common', $page_data);
	}
	public function update($param=''){
        ...
        if($this->form_validation->run() == false){
	        ...
	        $update = $this->db->update('magazine_content',$data);
	        if(isset($update)){
                $message = array('message'=>"Magazine Content Updated Successfully", 'class'=>'success');
            }else{
                $message = array('message'=>"Failed to Update Magazine Content", 'class'=>'danger');
            }
        }
        $this->session->set_flashdata('flash_message',$message);
        redirect(site_url('admin/magazine_content'),'refresh');
    ...
    public function delete($param='')
	{
        ...
        $delete = $this->db->where('id', $param)->delete('magazine_content');
        
        if(isset($delete)){
            $message = array('message'=>"Magazine Content Delete Successfully", 'class'=>'success');
        }else{
            $message = array('message'=>"Failed to Delete Magazine Content", 'class'=>'danger');
        }
        $this->session->set_flashdata('flash_message',$message);
        redirect(site_url('admin/magazine_content'),'refresh');
	}
	...
	public function fetch_data() {
        ...
        $main_table = 'magazine_content'; // Main table
        $controller_name = "admin/magazine_content"; // Controller name
