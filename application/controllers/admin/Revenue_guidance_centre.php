...
class Revenue_guidance_centre extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $page_data['page_title'] = "Revenue Guidance Centre";
    ...
    public function create()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            redirect(site_url('admin/Revenue_guidance_centre'), 'refresh');
        } else {
            ...
            $insert = $this->db->insert('revenue_guidance_centre', $data);
            if (isset($insert)) {
                $message = array('message' => "Revenue Guidance Centre Created Successfully", 'class' => 'success');
            } else {
                $message = array('message' => "Failed to Create Revenue Guidance Centre", 'class' => 'danger');
            }
        }
        $this->session->set_flashdata('flash_message', $message);
        redirect(site_url('admin/Revenue_guidance_centre'), 'refresh');
    ...
    public function edit($param = '')
    {
        ...
        $page_data['page_name'] = 'revenue_guidance_centre';
        $page_data['languages'] = $languages;
        $page_data['row_data'] = $this->db->get_where('revenue_guidance_centre', array('id' => $param))->row_array();
        $this->load->view('admin/common', $page_data);
    }
    public function update($param = '')
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $update = $this->db->update('revenue_guidance_centre', $data);
            if (isset($update)) {
                $message = array('message' => "Revenue Guidance Centre Updated Successfully", 'class' => 'success');
            } else {
                $message = array('message' => "Failed to Update Revenue Guidance Centre", 'class' => 'danger');
            }
        }
        $this->session->set_flashdata('flash_message', $message);
        redirect(site_url('admin/Revenue_guidance_centre'), 'refresh');
    ...
    public function delete($param = '')
    {
        ...
        $delete = $this->db->where('id', $param)->delete('revenue_guidance_centre');

        if (isset($delete)) {
            $message = array('message' => "Revenue Guidance Centre Delete Successfully", 'class' => 'success');
        } else {
            $message = array('message' => "Failed to Delete Revenue Guidance Centre", 'class' => 'danger');
        }
        $this->session->set_flashdata('flash_message', $message);
        redirect(site_url('admin/Revenue_guidance_centre'), 'refresh');
    }
    ...
    public function fetch_data()
    {
        ...
        $main_table = 'revenue_guidance_centre'; // Main table
        $controller_name = "admin/Revenue_guidance_centre"; // Controller name
