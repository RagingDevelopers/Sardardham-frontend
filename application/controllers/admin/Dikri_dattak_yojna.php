...
class Dikri_dattak_yojna extends CI_Controller {
	...
	public function index() {
	    ...
	    $page_data['page_name'] = "dikri_dattak_yojna";
        $page_data['page_title'] = "Dikri Dattak Yojna";
	...
	public function create(){
	   ...
	   // $this->form_validation->set_rules('photo', 'Photo', 'required');
        ...
        if($this->form_validation->run() == false){
            ...
            redirect(site_url('admin/dikri_dattak_yojna'),'refresh');
        }else{
            ...
            $insert = $this->db->insert('dikri_dattak_yojna',$data);          
            if(isset($insert)){
                $message = array('message'=>"Dikri Dattak Yojna Created Successfully", 'class'=>'success');
            }else{
                $message = array('message'=>"Failed to Create Dikri Dattak Yojna", 'class'=>'danger');
            }
        }
        $this->session->set_flashdata('flash_message',$message);
        redirect(site_url('admin/dikri_dattak_yojna'),'refresh');
	...
	public function edit($param=''){
        ...
        $page_data['page_name'] = 'dikri_dattak_yojna';
        $page_data['languages'] = $languages;
        $page_data['row_data']  =   $this->db->get_where('dikri_dattak_yojna',array('id'=>$param))->row_array();
        $this->load->view('admin/common', $page_data);
	}
	public function update($param=''){
        ...
        if($this->form_validation->run() == false){
	        ...
	        $update = $this->db->update('dikri_dattak_yojna',$data);
	        if(isset($update)){
                $message = array('message'=>"Dikri Dattak Yojna Updated Successfully", 'class'=>'success');
            }else{
                $message = array('message'=>"Failed to Update Dikri Dattak Yojna", 'class'=>'danger');
            }
        }
        $this->session->set_flashdata('flash_message',$message);
        redirect(site_url('admin/dikri_dattak_yojna'),'refresh');
    ...
    public function delete($param='')
	{
        ...
        $delete = $this->db->where('id', $param)->delete('dikri_dattak_yojna');
        
        if(isset($delete)){
            $message = array('message'=>"Dikri Dattak Yojna Delete Successfully", 'class'=>'success');
        }else{
            $message = array('message'=>"Failed to Delete Dikri Dattak Yojna", 'class'=>'danger');
        }
        $this->session->set_flashdata('flash_message',$message);
        redirect(site_url('admin/dikri_dattak_yojna'),'refresh');
	}
	...
	public function fetch_data() {
        ...
        $main_table = 'dikri_dattak_yojna'; // Main table
        $controller_name = "admin/Dikri_dattak_yojna"; // Controller name
