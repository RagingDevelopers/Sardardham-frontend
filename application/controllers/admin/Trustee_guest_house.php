...
class Trustee_guest_house extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $page_data['page_title'] = "Trustee Guest House";
    ...
    public function create()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            redirect(site_url('admin/trustee_guest_house'), 'refresh');
        } else {
            ...
            $insert = $this->db->insert('trustee_guest_house', $data);
            if (isset($insert)) {
                $message = array('message' => "Trustee Guest House Created Successfully", 'class' => 'success');
            } else {
                $message = array('message' => "Failed to Create Trustee Guest House", 'class' => 'danger');
            }
        }
        $this->session->set_flashdata('flash_message', $message);
        redirect(site_url('admin/trustee_guest_house'), 'refresh');
    ...
    public function edit($param = '')
    {
        ...
        $page_data['page_name'] = 'trustee_guest_house';
        $page_data['languages'] = $languages;
        $page_data['row_data'] = $this->db->get_where('trustee_guest_house', array('id' => $param))->row_array();
        $this->load->view('admin/common', $page_data);
    }
    public function update($param = '')
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $update = $this->db->update('trustee_guest_house', $data);
            if (isset($update)) {
                $message = array('message' => "Trustee Guest House Updated Successfully", 'class' => 'success');
            } else {
                $message = array('message' => "Failed to Update Trustee Guest House", 'class' => 'danger');
            }
        }
        $this->session->set_flashdata('flash_message', $message);
        redirect(site_url('admin/trustee_guest_house'), 'refresh');
    ...
    public function delete($param = '')
    {
        ...
        $delete = $this->db->where('id', $param)->delete('trustee_guest_house');

        if (isset($delete)) {
            $message = array('message' => "Trustee Guest House Delete Successfully", 'class' => 'success');
        } else {
            $message = array('message' => "Failed to Delete Trustee Guest House", 'class' => 'danger');
        }
        $this->session->set_flashdata('flash_message', $message);
        redirect(site_url('admin/trustee_guest_house'), 'refresh');
    }
    ...
    public function fetch_data()
    {
        ...
        $main_table = 'trustee_guest_house'; // Main table
        $controller_name = "admin/trustee_guest_house"; // Controller name
