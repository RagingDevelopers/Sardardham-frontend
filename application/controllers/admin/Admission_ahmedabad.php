...
class Admission_ahmedabad extends CI_Controller {
	...
	public function index() {
	    ...
	    $page_data['page_name'] = "admission_ahmedabad";
        $page_data['page_title'] = "Ahmedabad Admission";
	...
	public function create(){
	   ...
	   // $this->form_validation->set_rules('photo', 'Photo', 'required');
        ...
        if($this->form_validation->run() == false){
            ...
            redirect(site_url('admin/admission_ahmedabad'),'refresh');
        }else{
            ...
            $insert = $this->db->insert('admission_ahmedabad',$data);          
            if(isset($insert)){
	...
	public function edit($param=''){
        ...
        $page_data['page_name'] = 'admission_ahmedabad';
        $page_data['languages'] = $languages;
        $page_data['row_data']  =   $this->db->get_where('admission_ahmedabad',array('id'=>$param))->row_array();
        $this->load->view('admin/common', $page_data);
	}
	public function update($param=''){
        ...
        if($this->form_validation->run() == false){
	        ...
	        $update = $this->db->update('admission_ahmedabad',$data);
	        if(isset($update)){
    ...
    public function delete($param='')
	{
        ...
        $delete = $this->db->where('id', $param)->delete('admission_ahmedabad');
	...
	public function fetch_data() {
        ...
        $main_table = 'admission_ahmedabad'; // Main table
        $controller_name = "admin/Admission_ahmedabad"; // Controller name
