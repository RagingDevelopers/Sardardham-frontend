...
class Hostel_facilities extends CI_Controller {
	...
	public function create(){
	   ...
	   // $this->form_validation->set_rules('photo', 'Photo', 'required');
        ...
        if($this->form_validation->run() == false){
            ...
            redirect(site_url('admin/hostel_facilities'),'refresh');
        }else{
            ...
            $insert = $this->db->insert('hostel_facilities',$data);          
            if(isset($insert)){
                $message = array('message'=>"Hostel Facilities Created Successfully", 'class'=>'success');
            }else{
                $message = array('message'=>"Failed to Create Hostel Facilities", 'class'=>'danger');
            }
        }
        $this->session->set_flashdata('flash_message',$message);
        redirect(site_url('admin/hostel_facilities'),'refresh');
	...
	public function edit($param=''){
        ...
        $page_data['page_name'] = 'hostel_facilities';
        $page_data['languages'] = $languages;
        $page_data['row_data']  =   $this->db->get_where('hostel_facilities',array('id'=>$param))->row_array();
        $this->load->view('admin/common', $page_data);
	}
	...
	public function update($param=''){
        ...
        if($this->form_validation->run() == false){
	        ...
	        $update = $this->db->update('hostel_facilities',$data);
	        if(isset($update)){
                $message = array('message'=>"Hostel Facilities Updated Successfully", 'class'=>'success');
            }else{
                $message = array('message'=>"Failed to Update Hostel Facilities", 'class'=>'danger');
            }
        }
        $this->session->set_flashdata('flash_message',$message);
        redirect(site_url('admin/hostel_facilities'),'refresh');
    ...
    public function delete($param='')
	{
        ...
        $delete = $this->db->where('id', $param)->delete('hostel_facilities');
        
        if(isset($delete)){
            $message = array('message'=>"Hostel Facilities Delete Successfully", 'class'=>'success');
        }else{
            $message = array('message'=>"Failed to Delete Hostel Facilities", 'class'=>'danger');
        }
        $this->session->set_flashdata('flash_message',$message);
        redirect(site_url('admin/hostel_facilities'),'refresh');
	}
	...
	public function fetch_data() {
        ...
        $main_table = 'hostel_facilities'; // Main table
        $controller_name = "admin/hostel_facilities"; // Controller name
