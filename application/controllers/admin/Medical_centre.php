...
class Medical_centre extends CI_Controller {
	...
	public function index() {
        ...
        $page_data['page_title'] = "Medical Centre";
	...
	public function create(){
	   ...
	   // $this->form_validation->set_rules('photo', 'Photo', 'required');
        ...
        if($this->form_validation->run() == false){
            ...
            redirect(site_url('admin/medical_centre'),'refresh');
        }else{
            ...
            $insert = $this->db->insert('medical_centre',$data);          
            if(isset($insert)){
                $message = array('message'=>"Medical Centre Created Successfully", 'class'=>'success');
            }else{
                $message = array('message'=>"Failed to Create Medical Centre", 'class'=>'danger');
            }
        }
        $this->session->set_flashdata('flash_message',$message);
        redirect(site_url('admin/medical_centre'),'refresh');
	...
	public function edit($param=''){
        ...
        $page_data['page_name'] = 'medical_centre';
        $page_data['languages'] = $languages;
        $page_data['row_data']  =   $this->db->get_where('medical_centre',array('id'=>$param))->row_array();
        $this->load->view('admin/common', $page_data);
	}
	public function update($param=''){
        ...
        if($this->form_validation->run() == false){
	        ...
	        $update = $this->db->update('medical_centre',$data);
	        if(isset($update)){
                $message = array('message'=>"Medical Centre Updated Successfully", 'class'=>'success');
            }else{
                $message = array('message'=>"Failed to Update Medical Centre", 'class'=>'danger');
            }
        }
        $this->session->set_flashdata('flash_message',$message);
        redirect(site_url('admin/medical_centre'),'refresh');
    ...
    public function delete($param='')
	{
        ...
        $delete = $this->db->where('id', $param)->delete('medical_centre');
        
        if(isset($delete)){
            $message = array('message'=>"Medical Centre Delete Successfully", 'class'=>'success');
        }else{
            $message = array('message'=>"Failed to Delete Medical Centre", 'class'=>'danger');
        }
        $this->session->set_flashdata('flash_message',$message);
        redirect(site_url('admin/medical_centre'),'refresh');
	}
	...
	public function fetch_data() {
        ...
        $main_table = 'medical_centre'; // Main table
        $controller_name = "admin/Medical_centre"; // Controller name
