...
class Business_development_centre extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $page_data['page_name'] = "business_development_centre";
        $page_data['page_title'] = "Business Development Centre";
    ...
    public function create()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            redirect(site_url('admin/business_development_centre'), 'refresh');
        } else {
            ...
            $insert = $this->db->insert('business_development_center', $data);
            if (isset($insert)) {
                $message = array('message' => "Business Development Centre Created Successfully", 'class' => 'success');
            } else {
                $message = array('message' => "Failed to Create Business Development Centre", 'class' => 'danger');
            }
        }
        $this->session->set_flashdata('flash_message', $message);
        redirect(site_url('admin/business_development_centre'), 'refresh');
    ...
    public function edit($param = '')
    {
        ...
        $languages = $this->Language_model->get_language();
        $page_data['page_title'] = 'Business Development Center';
        $page_data['page_name'] = 'business_development_centre';
        $page_data['languages'] = $languages;
        $page_data['row_data'] = $this->db->get_where('business_development_center', array('id' => $param))->row_array();
        $this->load->view('admin/common', $page_data);
    }
    public function update($param = '')
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $update = $this->db->update('business_development_center', $data);
            if (isset($update)) {
                $message = array('message' => "Business Development Centre Updated Successfully", 'class' => 'success');
            } else {
                $message = array('message' => "Failed to Update Business Development Centre", 'class' => 'danger');
            }
        }
        $this->session->set_flashdata('flash_message', $message);
        redirect(site_url('admin/business_development_centre'), 'refresh');
    ...
    public function delete($param = '')
    {
        ...
        $delete = $this->db->where('id', $param)->delete('business_development_center');

        if (isset($delete)) {
            $message = array('message' => "Business Development Centre Delete Successfully", 'class' => 'success');
        } else {
            $message = array('message' => "Failed to Delete Business Development Centre", 'class' => 'danger');
        }
        $this->session->set_flashdata('flash_message', $message);
        redirect(site_url('admin/business_development_centre'), 'refresh');
    }
    ...
    public function fetch_data()
    {
        ...
        $main_table = 'business_development_center'; // Main table
        $controller_name = "admin/business_development_centre"; // Controller name
