...
.swiper-image-one {
  background-image: url(https://rd.ragingdevelopers.com/sardardham/upload/888.png);
...
<div class="inner-page fw-bold text-center" style="background-image: url('<?=base_url("upload/web_new.png");?>');"><span class="p-5">Philanthropist</span></div>

<div class="container-fluid">
    <section id="about-part" class="pt-40 pb-0">
        <div class="row">
            <div class="col-12 col-lg-12 col-md-12 col-sm-12">
                <h2><b>Philanthropist</b></h2>
                <div class="bar"></div>
            </div>
        </div>
    </section>
            ...
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide swiper-slide-one">
                    <div class="swiper-image" data-swiper-parallax-y="-20%">
                        <a target="_blank" href="#" class="swiper-image-inner swiper-image-left" style="background-image: url(<?=base_url()?>upload/<?=$add_img[$x]['photo'];?>);">
                        </a>
                    </div>
                </div>
                <?php } ?>
