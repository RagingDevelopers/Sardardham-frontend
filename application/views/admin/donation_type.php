<div class="container">
    ...
    <div class="col-md-12 pt-5">
        <div class="card card-primary">
            ...
            <form action="<?php if (isset($row_data)) {
                echo base_url() . 'admin/donation_type/update/' . $row_data['id'];
            } else {
                echo base_url() . 'admin/donation_type/create';
            } ?>" method="post">
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                } ?>" class="form-control" id="sequence" placeholder="" required>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="name" class="form-control" id="name" value="<?php if (isset($row_data)) {
                                    echo $row_data['name'];
                                } ?>" required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="amount" value="<?php if (isset($row_data)) {
                                    echo $row_data['amount'];
                                } ?>" class="form-control" id="amount" placeholder="" required>
                            </div>
                        </div>
                    </div>
    ...
    <div class="card">
        <div class="card-header bg-primary">
            <h3 class="card-title">Donation Type Table</h3>
        </div>
...
<script>
    $(document).ready(function () {
        ...
        $('#datatable').DataTable({
            ...
            "serverSide": true,
            "ajax": {
                "url": "<?php echo base_url('admin/donation_type/fetch_data'); ?>",
                "type": "POST",
                "data": function (d) {
