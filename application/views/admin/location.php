...
<?php $this->session->set_flashdata('flash_message', "");
    ...
    <div class="col-md-12 pt-5">
        <div class="card card-primary">
            ...
            <form action="<?php if(isset($row_data)){ echo base_url().'admin/location/update/'.$row_data['id']; }else{ echo base_url().'admin/location/create'; } ?>" method="post">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="title" value="<?php if(isset($row_data)){ echo $row_data['title']; } ?>" class="form-control" id="" placeholder="Enter Title" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="link" value="<?php if(isset($row_data)){ echo $row_data['link']; } ?>" class="form-control" id="" placeholder="">
                    </div>
                    <div class="form-group">
                        <label for="">Address<span class="text-danger">*</span></label>
                        <textarea name="address" id="address" required>
                            <?php if(isset($row_data)){ echo $row_data['address']; } ?>
                        </textarea>
                    </div>
                    <div class="form-group">
                        <label for="">Footer Information<span class="text-danger">*</span></label>
                        <textarea name="footer_info" id="footer_info">
                            <?php if(isset($row_data)){ echo $row_data['footer_info']; } ?>
                        </textarea>
                    </div>
                </div>
...
$(document).ready(function() {
  $('#address,#footer_info').summernote({
...
$(document).ready(function() {
    ...
    $('#datatable').DataTable({
        ...
        "serverSide": true,
        "ajax": {
            "url": "<?php echo base_url('admin/Location/fetch_data'); ?>",
            "type": "POST",
            "data": function(d) {
        ...
        "columns": [
            ...
            { "title": "Footer Info", "orderable": false },
