<div class="container">
    ...
    <div class="col-md-12 pt-5">
        <div class="card card-primary">
            <div class="card-header">
                <h3 class="card-title">Scholarship Scheme</h3>
            </div>
            <form action="<?php if (isset($row_data)) {
                echo base_url() . 'admin/scholarship_scheme/update/' . $row_data['id'];
            } else {
                echo base_url() . 'admin/scholarship_scheme/create';
            } ?>" method="post">
                <div class="card-body">
    ...
    <div class="card">
        <div class="card-header bg-primary">
            <h3 class="card-title">Scholarship Scheme Table</h3>
        </div>
...
<script>
    $(document).ready(function () {
        ...
        $('#datatable').DataTable({
            ...
            "serverSide": true,
            "ajax": {
                "url": "<?php echo base_url('admin/scholarship_scheme/fetch_data'); ?>",
                "type": "POST",
                "data": function (d) {
