...
<?php $this->session->set_flashdata('flash_message', "");
    ...
    <div class="col-md-12 pt-5">
        <div class="card card-primary">
            <div class="card-header">
                <h3 class="card-title">Yuva Sangathan</h3>
            </div>
            <form action="<?php if(isset($row_data)){ echo base_url().'admin/yuva_sangathan/update/'.$row_data['id']; }else{ echo base_url().'admin/yuva_sangathan/create'; } ?>" enctype="multipart/form-data" method="post">
                <div class="card-body">
    ...
    <div class="card">
        <div class="card-header bg-primary">
            <h3 class="card-title">Yuva Sangathan Table</h3>
        </div>
...
$(document).ready(function() {
    ...
    $('#datatable').DataTable({
        ...
        "serverSide": true,
        "ajax": {
            "url": "<?php echo base_url('admin/Yuva_sangathan/fetch_data'); ?>",
            "type": "POST",
            "data": function(d) {
