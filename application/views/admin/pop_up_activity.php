...
<?php $this->session->set_flashdata('flash_message', "");
    ...
    <div class="col-md-12 pt-3">
        <div class="card card-primary">
            <div class="card-header">
                <h3 class="card-title">Pop Up Activity</h3>
            </div>
            <form action="<?php if(isset($row_data)){ echo base_url().'admin/pop_up_activity/update/'.$row_data['id']; }else{ echo base_url().'admin/pop_up_activity/create'; } ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="link" value="<?php if(isset($row_data)){ echo $row_data['link']; } ?>" autocomplete="off" class="form-control" id="link" placeholder="Enter link" required>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="date" name="schedule_date" value="<?php if(isset($row_data)){ echo $row_data['schedule_date']; } ?>" class="form-control" id="schedule_date" placeholder="Enter schedule date" required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="end_date">End Date <span class="text-danger">*</span></label>
                                <input type="date" name="end_date" value="<?php if(isset($row_data)){ echo $row_data['end_date']; } ?>" class="form-control" id="end_date" placeholder="Enter end date" required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <div class="custom-file">
                                        <input type="file" name="photo" class="custom-file-input" id="exampleInputFile1">
    ...
    <div class="card">
        <div class="card-header bg-primary">
            <h3 class="card-title">Pop Up Activity Table</h3>
        </div>
...
$(document).ready(function() {
    ...
    $('#datatable').DataTable({
        ...
        "serverSide": true,
        "ajax": {
            "url": "<?php echo base_url('admin/Pop_up_activity/fetch_data'); ?>",
            "type": "POST",
            // "data": function(d) {
    ...
    $(document).on('change', '.changeStatus', function() {
        ...
        $.ajax({
            url: '<?php echo base_url("admin/Pop_up_activity/change_status"); ?>',
            type: 'POST',
            data: {
                id: id,
                status: newStatus
