...
<?php $this->session->set_flashdata('flash_message', "");
    ...
    <div class="col-md-12 pt-5">
        <div class="card card-primary">
            <div class="card-header">
                <h3 class="card-title">President Message</h3>
            </div>
            <form action="<?php if(isset($row_data)){ echo base_url().'admin/president_message/update/'.$row_data['id']; }else{ echo base_url().'admin/president_message/create'; } ?>" enctype="multipart/form-data" method="post">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        <label for="">Main Title<span class="text-danger">*</span></label>
                        <input type="text" name="main_title" value="<?php if(isset($row_data)){ echo $row_data['main_title']; } ?>" class="form-control" id="" placeholder="Enter Title" required>
                    </div>
                    <div class="form-group">
                        <label for="">Sub Title<span class="text-danger">*</span></label>
                        <input type="text" name="sub_title" value="<?php if(isset($row_data)){ echo $row_data['sub_title']; } ?>" class="form-control" id="" placeholder="Enter Title" required>
                    </div>
                    <div class="form-group">
    ...
    <div class="card">
        <div class="card-header bg-primary">
            <h3 class="card-title">President Message Table</h3>
        </div>
...
$(document).ready(function() {
    ...
    $('#datatable').DataTable({
        ...
        "serverSide": true,
        "ajax": {
            "url": "<?php echo base_url('admin/President_message/fetch_data'); ?>",
            "type": "POST",
            "data": function(d) {
