...
<?php $this->session->set_flashdata('flash_message', "");
    ...
    <div class="col-md-12 pt-5">
        <div class="card card-primary">
            <div class="card-header">
                <h3 class="card-title">Mission Vision Goals</h3>
            </div>
            <form action="<?php if(isset($row_data)){ echo base_url().'admin/mission_vision/update/'.$row_data['id']; }else{ echo base_url().'admin/mission_vision/create'; } ?>" method="post">
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select name="type" class="form-control" id="type" required>
                                    ...
                                    <option value="Mission" <?= ((isset($row_data) && ($row_data['type'] == "Mission")) ? "selected" : "") ?>>Mission</option>
                                    <option value="Vision" <?= ((isset($row_data) && ($row_data['type'] == "Vision")) ? "selected" : "") ?>>Vision</option>
                                    <option value="Goals" <?= ((isset($row_data) && ($row_data['type'] == "Goals")) ? "selected" : "") ?>>Goals</option>
                                </select>
                            </div>
                        </div>
                    </div>
    ...
    <div class="card">
        <div class="card-header bg-primary">
            <h3 class="card-title">Mission Vision Goals Table</h3>
        </div>
...
$(document).ready(function() {
    ...
    $('#datatable').DataTable({
        ...
        "serverSide": true,
        "ajax": {
            "url": "<?php echo base_url('admin/Mission_vision/fetch_data'); ?>",
            "type": "POST",
            "data": function(d) {
