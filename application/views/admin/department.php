...
<?php $this->session->set_flashdata('flash_message', "");
    ...
    <div class="col-md-12 pt-5">
        <div class="card card-primary">
            ...
            <form action="<?php if(isset($row_data)){ echo base_url().'admin/department/update/'.$row_data['id']; }else{ echo base_url().'admin/department/create'; } ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="card-body">
                    <div class="row">
                     ...
                     <div class="form-group">
                        ...
                        <input type="email" name="email" value="<?php if(isset($row_data)){ echo $row_data['email']; } ?>" class="form-control" id="exampleInputEmail1" placeholder="Enter email" required>
                    </div>
...
$(document).ready(function() {
    ...
    $('#datatable').DataTable({
        ...
        "serverSide": true,
        "ajax": {
            "url": "<?php echo base_url('admin/Department/fetch_data'); ?>",
            "type": "POST",
            "data": function(d) {
