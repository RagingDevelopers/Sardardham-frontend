...
<?php $this->session->set_flashdata('flash_message', "");
    ...
    <div class="col-md-12 pt-5">
        <div class="card card-primary">
            ...
            <form action="<?php if(isset($row_data)){ echo base_url().'admin/Create_link/update/'.$row_data['id']; }else{ echo base_url().'admin/Create_link/create'; } ?>" method="post" enctype="multipart/form-data">
...
$(document).ready(function() {
    ...
    $('#datatable').DataTable({
        ...
        "serverSide": true,
        "ajax": {
            "url": "<?php echo base_url('admin/Create_link/fetch_data'); ?>",
            "type": "POST",
            "data": function(d) {
