...
<?php $this->session->set_flashdata('flash_message', "");
    ...
    <div class="col-md-12 pt-5">
        <div class="card card-primary">
            <div class="card-header">
                <h3 class="card-title">Medical Centre</h3>
            </div>
            <form action="<?php if(isset($row_data)){ echo base_url().'admin/medical_centre/update/'.$row_data['id']; }else{ echo base_url().'admin/medical_centre/create'; } ?>" method="post">
                <div class="card-body">
    ...
    <div class="card">
        <div class="card-header bg-primary">
            <h3 class="card-title">Medical Centre Table</h3>
        </div>
...
$(document).ready(function() {
    ...
    $('#datatable').DataTable({
        ...
        "serverSide": true,
        "ajax": {
            "url": "<?php echo base_url('admin/medical_centre/fetch_data'); ?>",
            "type": "POST",
            "data": function(d) {
